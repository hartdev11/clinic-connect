  ...
  return (
    <div className="min-h-[55vh] flex flex-col items-center justify-center px-6 py-12 text-center">
      <h2 className="text-xl font-semibold text-surface-800">
        {isNotFound ? "ไม่พบข้อมูลสำหรับหน้าผู้ดูแลระบบ" : "ระบบผู้ดูแลเกิดข้อผิดพลาด"}
      </h2>
      <p className="mt-2 max-w-md text-sm text-surface-600">
        {isNotFound
          ? "ไม่พบเส้นทางหรือข้อมูลที่ต้องการในส่วนผู้ดูแล กรุณาตรวจสอบ URL อีกครั้ง"
          : "เกิดข้อผิดพลาดขณะโหลดข้อมูลผู้ดูแลระบบ กรุณาลองใหม่อีกครั้งในภายหลัง"}
      </p>
      <button
        type="button"
        onClick={reset}
